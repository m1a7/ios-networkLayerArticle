...
К примеру если вы хотите во время получения данных из интернета отображать прогресс загрузки, при использовании `RXNetworkOperations` вам не потребуется реализовывать методы протокола, все необходимые данные вы можете получить в соответствующих блоках.  
