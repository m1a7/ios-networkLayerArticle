...
- [Детальный обзоры модулей сетевого слоя](#Детальный-обзоры-модулей-сетевого-слоя)
    ...
    - [🌐🕹 APIManager.m](#APIManager.m)
        ...
        - [Краткое объяснение механизма действий при возникновении 401 ошибки](механизма-действий-при-возникновении-401)
        - [Как сетевой слой обрабатывает ошибки аутентификации](Как-сетевой-слой-обрабатывает-ошибки-аутентификации)
...
#### Краткое объяснение механизма действий при возникновении 401 ошибки <a name="механизма-действий-при-возникновении-401"></a>
